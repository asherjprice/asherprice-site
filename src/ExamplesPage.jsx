...
const EXAMPLES = [
  { slug: "cafe",         tag: "CAFÉ",              welsh: "Caffi",        title: "Rhymney Roasters",    meta: "Ordering · menu · loyalty",   description: "Interactive coffee configurator — pick your base, size, milk and extras. The site IS the ordering experience." },
  { slug: "pizza",        tag: "PIZZA",             welsh: "Pitsa",        title: "Forno Blackwood",     meta: "Ordering · delivery · SMS",   description: "Build-your-own pizza with animated toppings. Practical, fun, and genuinely useful for ordering." },
  { slug: "barber",       tag: "BARBER",            welsh: "Barbwr",       title: "Valley Cuts",         meta: "Booking · gallery",           description: "Ticket-strip layout with a spinning barber pole that reveals prices. Old-school charm, properly built." },
  { slug: "pub",          tag: "PUB",               welsh: "Tafarn",       title: "The Gwent Arms",      meta: "Events · menu · bookings",    description: "Beer-tap wall — click a handle, watch the pour animation, get tasting notes and price. Built for real-ale pubs." },
  { slug: "plumber",      tag: "PLUMBER",           welsh: "Plymwr",       title: "Caerphilly Plumbing", meta: "Quote form · AI triage",      description: "Instant quote calculator with a live countdown timer. Pick the job, set urgency, get a price. Trust on sight." },
  { slug: "salon",        tag: "NAIL SALON",        welsh: "Ewinedd",      title: "Ysbryd Nails",        meta: "Booking · loyalty",           description: "Liquid-glass morphism with aurora backgrounds. Dark-luxury aesthetic, kinetic typography, visible 5-star reviews." },
  { slug: "photographer", tag: "PHOTOGRAPHER",      welsh: "Ffotograffydd", title: "Reel Light Studio",   meta: "Portfolio · enquiries",       description: "Horizontal film strip you drag through — portfolio as physical film. No vertical scroll at all." },
  { slug: "vape",         tag: "VAPE SHOP",         welsh: "Siop Anwedd",  title: "Neon Valleys",         meta: "Product catalogue · flavour picker", description: "Neon-arcade aesthetic with a slot-machine flavour reveal. Bold, memorable, on-brand." },
  { slug: "indian",       tag: "INDIAN RESTAURANT", welsh: "Bwyty Indiaidd", title: "Spice Lane",           meta: "Menu · ordering · delivery", description: "Spice-heat slider filters the menu from mild to inferno. The kind of feature that sells websites." },
];
